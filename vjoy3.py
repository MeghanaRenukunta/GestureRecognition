...
def calc_bounding_rect(image,image1, landmarks,handedness,inp):
    ...
    if(inp==1):
        if x>=150 and x<=250 and y>=100 and y<=200:
        ...
        elif x>=200 and x<=360 and y<100:
            ...
            # time.sleep(2)
            # detect_gesture(1)
        elif x>=200 and x<=360 and y>200:
            ...
            # detect_gesture(3)
        elif x>360 and y>=100 and y<=200:
        ...
        if x>=200 and x<=540 and y>=100 and y<=200:
            print("No Movement")
            cv.rectangle(image1, (left, top), (right, bottom), (255,0, 0), 2)
            cv.putText(image1, 'No Movement', (left, top - 10), cv.FONT_HERSHEY_SIMPLEX, 0.9, (255,0, 0), 2)
            # global lastrequesttime
            ...
            # detect_gesture(3)
        elif x>540 and y>=100 and y<=200:
                print("Right side Movement")
                cv.rectangle(image1, (left, top), (right, bottom), (0, 255, 0), 2)
                cv.putText(image1, 'Moving Right', (left, top - 10),cv.FONT_HERSHEY_SIMPLEX, 0.9, (0,255, 0), 2)
                if (time.time()-lastrequesttime)>1:
